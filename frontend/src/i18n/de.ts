...
export const de = {
  ...
  admin: {
    ...
    processingLoading: 'Warteschlange wird geladen…',
    processingWindowOpen:
      'Das Zeitfenster der Verarbeitung ist offen ({{start}}–{{end}}). Wartende Aufträge laufen der Reihe nach an.',
    processingWindowClosed:
      'Das Zeitfenster der Verarbeitung ist geschlossen (es gilt {{start}}–{{end}}). Nur als „sofort" angeforderte Aufträge laufen jetzt.',
    processingWaitingForWindow:
      '{{count}} Auftrag/Aufträge warten darauf, dass es sich öffnet.',
    processingPending: 'Wartet',
    processingRunning: 'Läuft',
    processingFailed: 'Gescheitert',
    processingDone: 'Fertig',
    processingRefreshed: 'Stand {{time}}',
    processingQueueTitle: 'Warteschlange',
    processingQueueEmpty: 'Es wartet und läuft gerade nichts.',
    processingFailuresTitle: 'Letzte Fehlschläge',
    processingFailuresEmpty: 'Keine gescheiterten Aufträge.',
    processingDurationsTitle: 'Dauer der Schritte',
    processingDurationsEmpty:
      'Noch keine abgeschlossenen Aufträge – sobald welche durchgelaufen sind, stehen hier die Dauern.',
    processingDurationsNote:
      'Median und Maximum der letzten {{count}} abgeschlossenen Aufträge. Der Median statt des Mittelwerts, damit eine einzelne lange Aufnahme das Bild nicht verschiebt; das Maximum daneben, weil genau der Ausreißer interessiert.',
    processingMedianTotal: 'Median gesamt',
    processingMaxTotal: 'Maximum gesamt',
    processingMedianStt: 'Median Spracherkennung',
    processingMedianCorrection: 'Median Glättung',
    processingMedianSummary: 'Median Zusammenfassung',
    processingColRecording: 'Aufnahme',
    processingColMode: 'Aufgabe',
    processingColAttempt: 'Versuch',
    processingColWaiting: 'Wartezeit',
    processingColSteps: 'Schritte',
    processingColError: 'Grund',
    processingUntitled: '(ohne Titel)',
    processingMode: {
      FULL: 'Volle Auswertung',
      TRANSCRIBE_ONLY: 'Nur Transkription',
      REPROCESS: 'Erneute Auswertung',
      RETRANSCRIBE: 'Erneute Transkription',
      RETRANSCRIBE_ONLY: 'Erneute Transkription (ohne Auswertung)',
    },
    processingImmediate: 'sofort',
    processingWaits: 'wartet auf Zeitfenster',
    processingAttemptOf: '{{attempts}} von {{max}}',
    processingRetry: 'Erneut versuchen',
    processingRetryHint:
      'Setzt den Auftrag zurück und stößt ihn sofort an – unabhängig vom Zeitfenster. Der Versuchszähler beginnt neu.',
    processingStepStt: 'Spracherkennung',
    processingStepCorrection: 'Glättung',
    processingStepSummary: 'Zusammenfassung',
    processingStepTotal: 'gesamt',
  ...
  errors: {
    ...
    processingLoad: 'Warteschlange konnte nicht geladen werden.',
