...
export const en: typeof de = {
  ...
  admin: {
    ...
    processingWindowOpen:
      'The processing window is open ({{start}}–{{end}}). Waiting jobs start one after another.',
    processingWindowClosed:
      'The processing window is closed (it runs {{start}}–{{end}}). Only jobs requested as "immediate" run now.',
    processingWaitingForWindow: '{{count}} job(s) are waiting for it to open.',
    processingPending: 'Waiting',
    processingRunning: 'Running',
    processingFailed: 'Failed',
    processingDone: 'Finished',
    processingRefreshed: 'As of {{time}}',
    processingQueueTitle: 'Queue',
    processingQueueEmpty: 'Nothing is waiting or running.',
    processingFailuresTitle: 'Recent failures',
    processingFailuresEmpty: 'No failed jobs.',
    processingDurationsTitle: 'Step durations',
    processingDurationsEmpty:
      'No finished jobs yet – durations appear here once some have run through.',
    processingDurationsNote:
      'Median and maximum of the last {{count}} finished jobs. The median rather than the mean, so a single long recording does not skew the picture; the maximum next to it, because the outlier is what matters.',
    processingMedianTotal: 'Median total',
    processingMaxTotal: 'Maximum total',
    processingMedianStt: 'Median speech recognition',
    processingMedianCorrection: 'Median smoothing',
    processingMedianSummary: 'Median summary',
    processingColRecording: 'Recording',
    processingColMode: 'Task',
    processingColAttempt: 'Attempt',
    processingColWaiting: 'Waited',
    processingColSteps: 'Steps',
    processingColError: 'Reason',
    processingUntitled: '(untitled)',
    processingMode: {
      FULL: 'Full analysis',
      TRANSCRIBE_ONLY: 'Transcript only',
      REPROCESS: 'Re-analysis',
      RETRANSCRIBE: 'Re-transcription',
      RETRANSCRIBE_ONLY: 'Re-transcription (without analysis)',
    },
    processingImmediate: 'immediate',
    processingWaits: 'waiting for window',
    processingAttemptOf: '{{attempts}} of {{max}}',
    processingRetry: 'Retry',
    processingRetryHint:
      'Resets the job and starts it right away – regardless of the window. The attempt counter starts over.',
    processingStepStt: 'Speech recognition',
    processingStepCorrection: 'Smoothing',
    processingStepSummary: 'Summary',
    processingStepTotal: 'total',
  ...
  errors: {
    ...
    processingLoad: 'The queue could not be loaded.',
